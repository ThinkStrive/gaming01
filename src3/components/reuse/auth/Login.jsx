...
const Login = ({ inputData, setInputData }) => {
  ...
  return (
    ...
    >
      ...
      <div
        className="bg-white opacity-90 backdrop-sepia-0 shadow-2xl 2xl:h-[50rem] lg:h-[70vh] lg:w-[33vw] md:h-[65vh] md:w-[55vw] h-[75vh] w-[85vw] rounded-3xl px-10 py-6 flex flex-col justify-center gap-5"
      ...
      >
        ...
        >
          <input
            ...
            className="border-b border-gray-400 outline-none bg-transparent lg:w-[100%] w-[95%] shadow-lg px-1 py-2 text-sm lg:text-md font-semibold login-input text-black"
            name="email"
            id="email"
          ...
          <div className="relative lg:w-[100%] w-[95%]">
            <input
              ...
              className="border-b border-gray-400 outline-none bg-transparent lg:w-[100%] w-[100%] shadow-lg px-1 py-2 text-sm lg:text-md font-semibold login-input text-black"
              name="password"
              id="password"
        ...
        <p className="text-xs m-0 text-black">
