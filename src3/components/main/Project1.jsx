  ...
  const tableRow = (category, count, lastHit, screen) => {
    return (
      <tr className="text-center">
        ...
        <td
          className={
            count <= 5 ? "bg-lightBlue1 text-black border hover:bg-softBlue hover:text-white" :
            count <= 10 ? "bg-mediumBlue1 text-white border hover:bg-softBlue hover:text-white" :
            count > 10 ? "bg-darkBlue1 text-white border hover:bg-softBlue hover:text-white":
